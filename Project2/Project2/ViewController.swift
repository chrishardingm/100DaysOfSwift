...
//  Project2
//
//  Created by Chris Harding on 10/18/20.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func buttonTapped(_ sender: UIButton) {
        ...
        let ac2 = UIAlertController(title: title, message: "You have answered 10 questions. Your score \(score)", preferredStyle: .alert)
